...
public class OpenWeather2Impl implements WeatherData{
	private static final Logger LOGGER = LogManager.getLogger(OpenWeather2Impl.class);
	...
	public static void main(String[] a)
	{
		...
		req.setCity("chennai");
		OpenWeather2Impl o=new OpenWeather2Impl(); 
